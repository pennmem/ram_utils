...
class THEventPreparation(RamTask):
    ...
    def run(self):
        ...
        score_path = os.path.join(self.pipeline.mount_point, 'data', 'events', 'RAM_' + task,
                                  self.pipeline.subject + '_score.mat')
        ...
        timing_path = os.path.join(self.pipeline.mount_point, 'data', 'events', 'RAM_' + task,
                                   self.pipeline.subject + '_timing.mat')
