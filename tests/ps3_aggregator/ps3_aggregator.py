...
from BuildAggregatePS3Table import BuildAggregatePS3Table
...
rsi = ReportSummaryInventory(label='PS3_aggregator')
# sets up processing pipeline
report_pipeline = ReportPipeline(workspace_dir=args.workspace_dir, mount_point=args.mount_point)

report_pipeline.add_task(BuildAggregatePS3Table(params=params, mark_as_completed=False))
