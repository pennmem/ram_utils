...
class ComputeTHClassPowers(RamTask):
    ...
    def restore(self):
        ...
        self.classify_pow_mat = joblib.load(self.get_path_to_resource_in_workspace(subject + '-classify_pow_mat.pkl'))
    ...
    def run(self):
        ...
        joblib.dump(self.classify_pow_mat, self.get_path_to_resource_in_workspace(subject + '-classify_pow_mat.pkl'))
