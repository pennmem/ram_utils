...
#$ -N REPORT
#$ -j y
#$ -o /scratch/RAM_maint/automated_reports/automated_reports.log
...
automated_reports_dir=/scratch/RAM_maint/automated_reports
...
# FR1
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/fr1_report_db
cd ${report_code_dir}

workspace_dir=/scratch/RAM_maint/automated_reports/FR1_reports
...
# FR3
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/fr_stim_report_db
cd ${report_code_dir}
...
python ${report_code_dir}/fr_stim_report_all.py  --task=RAM_CATFR3 \
 --recompute-on-no-status --workspace-dir=${workspace_dir} --status-output-dir=${status_output_dir} ${exit_on_no_change_flag}\
 --skip-subjects R1093J_1


# PAL3
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/pal_stim_report_db
cd ${report_code_dir}
...
# TH3
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/th_stim_report_db
cd ${report_code_dir}
...
# FR1 CatFR1 joint
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/fr1_catfr1_joint_report_db
cd ${report_code_dir}
...
# PAL1
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/pal1_report_db
cd ${report_code_dir}
...
# PS1
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/ps_report_db
cd ${report_code_dir}
...
# PAL_PS1
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/ps_pal_report_db
cd ${report_code_dir}
...
# TH_PS1
#report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/ps_th_report_db
#cd ${report_code_dir}
#
...
## TH1
report_code_dir=/home2/RAM_maint/RAM_UTILS_GIT/tests/th1_report_db
cd ${report_code_dir}
