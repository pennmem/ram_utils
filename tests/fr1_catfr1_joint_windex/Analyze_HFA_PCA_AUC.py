...
class Analyze_HFA_PCA_AUC(ReportRamTask):
    def __init__(self, params, mark_as_completed=True):
        super(Analyze_HFA_PCA_AUC,self).__init__(mark_as_completed)
        self.params = params
        self.pow_mat = None
    ...
    def restore(self):
        ...
        self.AUCs = joblib.load(self.get_path_to_resource_in_workspace('fs_hfa_pca_AUCs.pkl'))
