...
class Analyze_LnP_HFA_AUC(ReportRamTask):
    def __init__(self, params, mark_as_completed=True):
        super(Analyze_LnP_HFA_AUC,self).__init__(mark_as_completed)
        self.params = params
        self.pow_mat = None
    ...
    def run(self):
        ...
        joblib.dump(self.outsample_probs, self.get_path_to_resource_in_workspace('fs_lnp_hfa_outsample_probs.pkl'))
        joblib.dump(self.AUCs, self.get_path_to_resource_in_workspace('fs_lnp_hfa_AUCs.pkl'))


    def restore(self):
        self.outsample_probs = joblib.load(self.get_path_to_resource_in_workspace('fs_lnp_hfa_outsample_probs.pkl'))
        self.AUCs = joblib.load(self.get_path_to_resource_in_workspace('fs_lnp_hfa_AUCs.pkl'))
