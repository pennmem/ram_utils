...
cml_parser.arg('--workspace-dir', '/scratch/zduey/samplefr5_biomarkers/')
cml_parser.arg('--experiment', 'FR5')
cml_parser.arg('--mount-point', '/')
cml_parser.arg('--subject', 'R1350D')
cml_parser.arg('--electrode-config-file', '/home1/zduey/ram_utils/testing/test_data/R1350D_18OCT2017L0M0NOSTIM.csv')
cml_parser.arg('--pulse-frequency', '200')
cml_parser.arg('--target-amplitude', '1.0')
cml_parser.arg('--anode', 'LAD6')
cml_parser.arg('--cathode', 'LAD7')
