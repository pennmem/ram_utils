...
cml_parser.arg('--workspace-dir', '/Volumes/rhino_root/scratch/leond/configs')
...
cml_parser.arg('--subject', 'R1370E')
cml_parser.arg('--electrode-config-file', '/Volumes/rhino_root/scratch/system3_configs/ODIN_configs/R1370E/R1370E_22NOV2017L0M0STIM.csv')
cml_parser.arg('--pulse-frequency', '200')
cml_parser.arg('--target-amplitude', '1.0', '0.5')
cml_parser.arg('--anodes', '2Rd8', '5Ld7')
cml_parser.arg('--cathodes', '2Rd9', '5Ld9')
cml_parser.arg('--min-amplitudes', '0.1')
