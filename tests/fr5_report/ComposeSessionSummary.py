...
class ComposeSessionSummary(ReportRamTask):
    ...
    def compose_fr_session_summary(self):
        ...
        fr_stim_table_by_phase = fr_stim_table.groupby('is_ps4')
        for phase,fr_stim_group_table in fr_stim_table_by_phase:
            # is_ps4 = fr_stim_group_table['is_ps4'].any()
            # if is_ps4:
            fr_stim_group_table_group = fr_stim_group_table.groupby('session')
            # else:
            ...
            for stim_param,fr_stim_session_table in fr_stim_group_table_group:
                ...
                session_summary.chisqr_last, session_summary.pvalue_last,_  = proportions_chisquare([session_summary.n_correct_stim, session_summary.n_correct_nonstim_last], [session_summary.n_total_stim, session_summary.n_total_nonstim_last])
