...
classdef StimControl < handle
    ...
    properties(Access = public)
        ...
        current_item_analyzed;  % flag that says not to compute on the present item again if true
        wavelet_transformer;
    ...
    methods (Access = public)
        ...
        function initialize(this)
           ...
           this.current_item_analyzed = false;
        ...
        function [decision, stopSession, errMsg] = stimChoice(this, experimentState, dataByChannel)
            ...
            if ~this.ks_test_done && control.isStateActive('SCORESCREEN') && (experimentState.list==6)
