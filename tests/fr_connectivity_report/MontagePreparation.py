...
class MontagePreparation(ReportRamTask):
    ...
    def restore(self):
        ...
        bipolar_pair_pairs = joblib.load(self.get_path_to_resource_in_workspace(subject + '-bipolar_pair_pairs.pkl'))
        ...
        self.pass_object('bipolar_pair_pairs', bipolar_pair_pairs)
    ...
    def run(self):
        ...
        try:
            ...
            bipolar_pair_pairs = []
            for i,bp1 in enumerate(bipolar_pairs):
                for j in xrange(i):
                    bp2 = bipolar_pairs[j]
                    if bp1[0]!=bp2[0] and bp1[0]!=bp2[1] and bp1[1]!=bp2[0] and bp1[1]!=bp2[1]:
                        bipolar_pair_pairs.append((j,i))
