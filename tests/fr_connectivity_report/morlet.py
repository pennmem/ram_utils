...
class MorletWaveletTransform(_object):
    ...
    def multiphasevec_powers_and_phases(self, signal, powers, phases):
        return _morlet.MorletWaveletTransform_multiphasevec_powers_and_phases(self, signal, powers, phases)

    def multiphasevec_c(self, signal, wavelets):
        return _morlet.MorletWaveletTransform_multiphasevec_c(self, signal, wavelets)

    def multiphasevec(self, signal, powers, phases=None):
        return _morlet.MorletWaveletTransform_multiphasevec(self, signal, powers, phases)

    def multiphasevec_complex(self, signal, wavelets):
        return _morlet.MorletWaveletTransform_multiphasevec_complex(self, signal, wavelets)
