...
class ComputePSPowers(RamTask):
    ...
    def compute_ps_powers(self, events, sessions, monopolar_channels, bipolar_pairs, experiment):
        ...
        for sess in sessions:
            ...
            eeg_pre_reader = EEGReader(events=sess_events, channels=monopolar_channels,
            ...
            for i_ev in xrange(n_events):
                ...
                eeg_post_reader = EEGReader(events=sess_events[i_ev:i_ev+1], channels=monopolar_channels,
            ...
            for i,bp in enumerate(bipolar_pairs):
                ...
                elec1 = np.where(monopolar_channels_np == bp[0])[0][0]
                elec2 = np.where(monopolar_channels_np == bp[1])[0][0]
