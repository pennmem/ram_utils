...
class ComputeFR1Powers(RamTask):
    ...
    def restore(self):
        self.pow_mat = joblib.load(self.get_path_to_resource_in_workspace(self.pipeline.subject+'-pow_mat.pkl'))
    ...
    def run(self):
        ...
        joblib.dump(self.pow_mat, self.get_path_to_resource_in_workspace(self.pipeline.subject+'-pow_mat.pkl'))
        self.pass_object('pow_mat', self.pow_mat)
