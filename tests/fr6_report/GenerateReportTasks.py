...
class GenerateTex(ReportRamTask):
    ...
    def generate_latex(self):
        ...
        if events is not None and all(events.shape):
            ...
            # TODO: With the multi stim-sites, first pass will go over session,
            # and the second pass will go over target (A, B, AB). Or, do a single
            ...
            for session_summary in session_summary:
                ...
                biomarker_tex = replace_template_to_string('biomarker_plots.tex.tpl',
                                                           {'<STIM_VS_NON_STIM_HALVES_PLOT_FILE_A>':session_summary.STIM_VS_NON_STIM_HALVES_PLOT_FILE,
                                                            '<STIM_VS_NON_STIM_HALVES_PLOT_FILE_B>':session_summary.STIM_VS_NON_STIM_HALVES_PLOT_FILE,
                                                            '<STIM_VS_NON_STIM_HALVES_PLOT_FILE_AB>':session_summary.STIM_VS_NON_STIM_HALVES_PLOT_FILE,
                ...
                session_tex = replace_template_to_string('fr6_session.tex.tpl',
                             {
                                 '<SESSIONS>': sessions,
                                 '<STIMTAG_A>': session_summary.stimtag,
                                 '<REGION_A>': session_summary.region_of_interest,
                                 '<STIMTAG_B>': session_summary.stimtag,
                                 '<REGION_B>': session_summary.region_of_interest,
                                 '<PULSE_FREQ_A>': session_summary.frequency,
                                 '<PULSE_FREQ_B>': session_summary.frequency,
                                 '<AMPLITUDE_A>': session_summary.amplitude,
                                 '<AMPLITUDE_B>': session_summary.amplitude,
                                 ...
                                 '<N_CORRECT_STIM_A>':session_summary.n_correct_stim,
                                 '<N_TOTAL_STIM_A>':session_summary.n_total_stim,
                                 '<N_CORRECT_NONSTIM_A>':session_summary.n_correct_nonstim,
                                 '<N_TOTAL_NONSTIM_A>':session_summary.n_total_nonstim,
                                 '<PC_FROM_STIM_A>':'%2.2f'%session_summary.pc_from_stim,
                                 '<PC_FROM_NONSTIM_A>':'%2.2f'%session_summary.pc_from_nonstim,
                                 '<CHISQR_A>':'%.4f'%session_summary.chisqr,
                                 '<PVALUE_A>':'%.4f'%session_summary.pvalue,
                                 '<N_STIM_INTR_A>': session_summary.n_stim_intr,
                                 '<PC_FROM_STIM_INTR_A>':'%2.2f'%session_summary.pc_from_stim_intr,
                                 '<N_NONSTIM_INTR_A>':session_summary.n_nonstim_intr,
                                 '<PC_FROM_NONSTIM_INTR_A>':'%2.2f'%session_summary.pc_from_nonstim_intr,
                                 '<N_CORRECT_STIM_B>':session_summary.n_correct_stim,
                                 '<N_TOTAL_STIM_B>':session_summary.n_total_stim,
                                 '<N_CORRECT_NONSTIM_B>':session_summary.n_correct_nonstim,
                                 '<N_TOTAL_NONSTIM_B>':session_summary.n_total_nonstim,
                                 '<PC_FROM_STIM_B>':'%2.2f'%session_summary.pc_from_stim,
                                 '<PC_FROM_NONSTIM_B>':'%2.2f'%session_summary.pc_from_nonstim,
                                 '<CHISQR_B>':'%.4f'%session_summary.chisqr,
                                 '<PVALUE_B>':'%.4f'%session_summary.pvalue,
                                 '<N_STIM_INTR_B>': session_summary.n_stim_intr,
                                 '<PC_FROM_STIM_INTR_B>':'%2.2f'%session_summary.pc_from_stim_intr,
                                 '<N_NONSTIM_INTR_B>':session_summary.n_nonstim_intr,
                                 '<PC_FROM_NONSTIM_INTR_B>':'%2.2f'%session_summary.pc_from_nonstim_intr,
                                 '<N_CORRECT_STIM_AB>':session_summary.n_correct_stim,
                                 '<N_TOTAL_STIM_AB>':session_summary.n_total_stim,
                                 '<N_CORRECT_NONSTIM_AB>':session_summary.n_correct_nonstim,
                                 '<N_TOTAL_NONSTIM_AB>':session_summary.n_total_nonstim,
                                 '<PC_FROM_STIM_AB>':'%2.2f'%session_summary.pc_from_stim,
                                 '<PC_FROM_NONSTIM_AB>':'%2.2f'%session_summary.pc_from_nonstim,
                                 '<CHISQR_AB>':'%.4f'%session_summary.chisqr,
                                 '<PVALUE_AB>':'%.4f'%session_summary.pvalue,
                                 '<N_STIM_INTR_AB>': session_summary.n_stim_intr,
                                 '<PC_FROM_STIM_INTR_AB>':'%2.2f'%session_summary.pc_from_stim_intr,
                                 '<N_NONSTIM_INTR_AB>':session_summary.n_nonstim_intr,
                                 '<PC_FROM_NONSTIM_INTR_AB>':'%2.2f'%session_summary.pc_from_nonstim_intr,
                                 '<STIM_AND_RECALL_PLOT_FILE_A>':session_summary.STIM_AND_RECALL_PLOT_FILE,
                                 '<STIM_AND_RECALL_PLOT_FILE_B>':session_summary.STIM_AND_RECALL_PLOT_FILE,
                                 '<STIM_AND_RECALL_PLOT_FILE_AB>':session_summary.STIM_AND_RECALL_PLOT_FILE,
                                 '<STIM_AND_RECALL_PLOT_FILE_NOSTIM>':session_summary.STIM_AND_RECALL_PLOT_FILE,
                                 '<PROB_STIM_PLOT_FILE_A>':session_summary.PROB_STIM_PLOT_FILE,
                                 '<PROB_STIM_PLOT_FILE_B>':session_summary.PROB_STIM_PLOT_FILE,
                                 '<PROB_STIM_PLOT_FILE_AB>':session_summary.PROB_STIM_PLOT_FILE,
