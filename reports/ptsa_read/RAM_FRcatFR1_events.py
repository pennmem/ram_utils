...
ev_params = {
    'catFR1':{
        'event_path': '/home/ctw/fusemounts/rhino/data/events/RAM_CatFR1/',
        'bad_subjects': ['R1044J','R1007D'],
        'outfile': '/home/ctw/Christoph/Analyses/RAM/RAM_catFR/data/RAM_catFR1_events20151106.npy'},
    'catFR2':{
        'event_path': '/home/ctw/fusemounts/rhino/data/events/RAM_CatFR2/',
        'bad_subjects': [],
        'outfile': '/home/ctw/Christoph/Analyses/RAM/RAM_catFR/data/RAM_catFR2_events20151106.npy'},
    'FR1':{
        'event_path': '/home/ctw/fusemounts/rhino/data/events/RAM_FR1/',
        'bad_subjects': ['R1063C','R1093J'],
        'outfile': '/home/ctw/Christoph/Analyses/RAM/RAM_FR/data/RAM_FR1_events20151106.npy'},
    'FR2':{
        'event_path': '/home/ctw/fusemounts/rhino/data/events/RAM_FR2/',
        'bad_subjects': [],
        'outfile': '/home/ctw/Christoph/Analyses/RAM/RAM_FR/data/RAM_FR2_events20151106.npy'}
}
...
event_struct_list = glob.glob(ev_params[exp]['event_path']+'R1*_events.mat')
event_struct_list.extend(glob.glob(ev_params[exp]['event_path']+'TJ*_events.mat'))
event_struct_list.extend(glob.glob(ev_params[exp]['event_path']+'UT*_events.mat'))
good_events = np.ones(len(event_struct_list),np.bool)
for e,evfile in enumerate(event_struct_list):
    for bs in ev_params[exp]['bad_subjects']:
        if bs in evfile:
            good_events[e] = False
...
np.save(ev_params[exp]['outfile'],all_evs)
