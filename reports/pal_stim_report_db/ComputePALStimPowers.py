...
class ComputePALStimPowers(ReportRamTask):
    def __init__(self, params, mark_as_completed=True):
        super(ComputePALStimPowers,self).__init__(mark_as_completed)
        self.params = params
        self.pow_mat = None
    ...
    def restore(self):
        ...
        self.pow_mat = joblib.load(self.get_path_to_resource_in_workspace(subject + '-' + task + '-pal_stim_pow_mat.pkl'))
    ...
    def run(self):
        ...
        joblib.dump(self.pow_mat, self.get_path_to_resource_in_workspace(subject + '-' + task + '-pal_stim_pow_mat.pkl'))
