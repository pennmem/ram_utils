...
class RamPopulator(object):
    ...
    def create_subject_JSON_stub(self,subject_code):
        ...
        tal_bipolar_node['md5'] = compute_md5_key(join(self.mount_point, p))
        ...
        tal_monopolar_node['md5'] = compute_md5_key(join(self.mount_point, p))
        ...
        eeg_params_reref_node['md5'] = compute_md5_key(join(self.mount_point, p))
        ...
        eeg_params_noreref_node['md5'] = compute_md5_key(join(self.mount_point, p))
        ...
        fr1_node['events'] = JSONNode.initialize_form_list(
            'path',p,
            'md5',compute_md5_key(join(self.mount_point, p))
        )
