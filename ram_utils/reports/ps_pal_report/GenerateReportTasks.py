...
class GenerateTex(ReportRamTask):
    ...
    def run(self):
        tex_template = get_template('ps_report.tex.tpl')
        tex_session_template = get_template('ps_session.tex.tpl')
        tex_sham_plots_template = get_template('ps_sham_plots.tex.tpl')
        tex_nosham_plots_template = get_template('ps_nosham_plots.tex.tpl')
        tex_ttest_table1_template = get_template('ttest_table1.tex.tpl')
        tex_ttest_table2_template = get_template('ttest_table2.tex.tpl')
        tex_ttest_against_sham_template = get_template('ttest_against_sham.tex.tpl')

        report_tex_file_name = self.pipeline.task + '-PAL1-' + self.pipeline.subject + '-' + 'report.tex'
