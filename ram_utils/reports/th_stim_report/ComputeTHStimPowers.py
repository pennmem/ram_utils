...
class ComputeTHStimPowers(ReportRamTask):
    def __init__(self, params, mark_as_completed=True):
        super(ComputeTHStimPowers,self).__init__(mark_as_completed)
        self.params = params
        self.pow_mat = None
    ...
    def restore(self):
        ...
        self.pow_mat = joblib.load(self.get_path_to_resource_in_workspace(subject + '-' + task + '-th_stim_pow_mat.pkl'))
        self.samplerate = joblib.load(self.get_path_to_resource_in_workspace(subject + '-samplerate.pkl'))

        self.pass_object('th_stim_pow_mat', self.pow_mat)
    ...
    def run(self):
        ...
        joblib.dump(self.pow_mat, self.get_path_to_resource_in_workspace(subject + '-' + task + '-th_stim_pow_mat.pkl'))
    ...
    def compute_powers(self, events, sessions,monopolar_channels, bipolar_pairs):
        ...
        for sess in sessions:
            ...
            print 'Computing TH3/TH4 powers'
